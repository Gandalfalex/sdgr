...
import {IntegerDataSet, PreviewData} from "../../../../../typedefs/spring_types";
...
import {IntegerDataSetProps} from "./DataSetHOC";

export const IntegerDataSetElement = (props: IntegerDataSetProps) => {
    ...
    let data = createData<IntegerDataSet>(dataSet)
    ...
    return (
        <CardSkeleton title={dataSet?.name} onEdit={handleEdit} dataType={dataSet.dataType} onDelete={handleDelete}
                      totalSteps={3}>
