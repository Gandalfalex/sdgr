...
public class ProjectController {
    ...
    @Timed(
        value = "getAllProjects.time",
        description = "Time taken to get all projects"
    )
    @AttachUser
    ...
    @Timed(
        value = "getProjectById.time",
        description = "Time taken to get project by id"
    )
    ...
    @Timed(
        value = "createNewProject.time",
        description = "Time taken to create new project"
    )
    ...
    @Timed(
        value = "updateProject.time",
        description = "Time taken to update project"
    )
    ...
    @Timed(
        value = "deleteProject.time",
        description = "Time taken to delete project"
    )
    ...
    @Timed(
        value = "downloadProject.time",
        description = "Time taken to download project"
    )
    ...
    @Timed(
        value = "uploadProject.time",
        description = "Time taken upload project"
    )
    ...
    private ProjectDTO toDTO(Project project) {
        return new ProjectDTO()
            ...
            .setId(project.getId())
            .setSending(threadOrganizer.checkIfRunning(project.getId()));
    }
}
